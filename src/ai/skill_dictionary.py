...
SKILL_SYNONYMS = {
    ...
    ##Finance
        # Finance et pilotage budgétaire
    "finance": [
    ...
    "pilotage budgétaire": [
        ...
        "pilotage du budget",
        "pilotage de budget",
        "coordination de processus budgétaire",
        "coordination de processus budgetaire",
    ],
    "gestion budgétaire": [
        "gestion budgetaire",
    ...
    "contrôle de gestion": [
        ...
        "structuration du controle de gestion",
    ],
    "reporting financier": [
    ...
    "recouvrement": [
        ...
        "gestion de portefeuille employeur",
    ],
    "sap": [
        "sap finance",
        "sap fi",
